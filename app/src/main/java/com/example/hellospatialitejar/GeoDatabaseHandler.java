...
import jsqlite.*; // this isn't recognized by android studio, but it might be OK by gradle
...
public class GeoDatabaseHandler {
    ...
    private static String DB_PATH = "/data/data/com.example.hellospatialitejar/databases";
